...
export const Html5Logo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="HTML5 icon">
...
export const Css3Logo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="CSS3 icon">
...
export const JavaScriptLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="JavaScript icon">
...
export const TypeScriptLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="TypeScript icon">
...
export const ReactLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="React JS logo">
...
export const NextjsLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Next.js logo">
...
export const TailwindLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Tailwind CSS logo">
...
export const BootstrapLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Bootstrap logo">
...
export const NodejsLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Node.js logo">
...
export const ExpressLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Express.js logo">
...
export const RestApiIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="REST API icon">
...
export const PostgresLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="PostgreSQL logo">
...
export const MongoLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="MongoDB logo">
...
export const MysqlLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="MySQL logo">
...
export const GitLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="Git logo">
...
export const GithubLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="#181717" role="img" aria-label="GitHub logo">
...
export const DockerLogo = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="#2496ED" role="img" aria-label="Docker logo">
...
export const CiCdIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="CI/CD icon">
...
export const AiAssistantIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" role="img" aria-label="AI Code Assistant icon">
...
export const PromptEngIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#9333EA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="Prompt Engineering icon">
...
export const McpIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#0284C7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="MCP icon">
...
export const AiDevIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="AI Project Development icon">
